...
admin.clickDeleteDataAdmin(data.getValue('Email', index))

admin.clickOKDeletePopup()

/*====== Verify Result ====== */
admin.verifyDataAdminDeleted(data.getValue('Username', index), data.getValue('Email', index))
ReportUtils.captureScreenshot()
